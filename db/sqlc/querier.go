...
type Querier interface {
	...
	GetAllDomains(ctx context.Context) ([]GetAllDomainsRow, error)
	GetAllStates(ctx context.Context) ([]GetAllStatesRow, error)
	...
	GetFilteredBusinesses(ctx context.Context, arg GetFilteredBusinessesParams) ([]BkBusiness, error)
	GetImageByBusinessId(ctx context.Context, businessID int64) ([]BkBusinessImage, error)
	GetImageByImageId(ctx context.Context, imageID int64) (BkBusinessImage, error)
	...
	RemoveUserPhotoLink(ctx context.Context, userID int64) error
	UpdateUserPhotoURL(ctx context.Context, arg UpdateUserPhotoURLParams) error
	UploadBusinessImage(ctx context.Context, arg UploadBusinessImageParams) (BkBusinessImage, error)
}
